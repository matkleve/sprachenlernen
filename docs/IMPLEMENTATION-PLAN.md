...
| **T-B10d** | Method surfaces property audit — align UI to study/34 | **Shipped 2026-08-16.** Plain effort on detail band; evidence disclosure-only; effort anchor in Practical; all requirement chips on cards; full-bleed hero kept |
...
| **6b** | ~~**T-B10d** — property audit alignment ([`study/34`](study/34-method-surfaces-property-audit.md))~~ — **shipped 2026-08-16** | Plain effort everywhere; all requirement chips on cards; evidence disclosure-only on detail |
