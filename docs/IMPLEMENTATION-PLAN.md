...
| **T-B10d** | Method surfaces property audit — align UI to study/34 | **Pending owner go (2026-08-16).** Remove effort dot scale on detail; evidence out of badge band; cap card logistics chips (duration + hosted + ≤2 blocking needs); effort anchor in Practical; optional `salientRequirementChips()` helper |
...
| **6b** | **T-B10d** — property audit alignment ([`study/34`](study/34-method-surfaces-property-audit.md)) | Plain effort everywhere; leaner card chips; evidence disclosure-only on detail — **blocked on owner go** |
