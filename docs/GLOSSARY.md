...
| **Listening defer** | Temporary *can't listen now* — 15 min default; type-only gap-fill when active. UI deferred to mixed-stack session chrome (not method menu). Not UC-020 exclusion. | mute, permanent opt-out |
