...
| **T-W6** | **Form practice engine** — inverse index + mixing + echo + pull-forward + cell task ids + introduction cap **shipped 2026-08-20**; remainder: answer routes (typed/build/spoken), wrong-answer cell recording. | UC-041 | [`form-practice.md`](../specs/service/form-practice.md), [`form-inverse-index.md`](../specs/service/form-inverse-index.md) | **Sensitive** | W-4 |
