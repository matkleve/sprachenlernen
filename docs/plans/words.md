...
| **T-W6** | **Form practice engine** — inverse index + mixing + echo rule **shipped 2026-08-20**; remainder: cell-based tasks, introduction cap, answer routes. | UC-041 | [`form-practice.md`](../specs/service/form-practice.md), [`form-inverse-index.md`](../specs/service/form-inverse-index.md) | **Sensitive** | W-4 |
