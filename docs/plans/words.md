...
| **T-W6** | **Form practice engine** — inverse index + mixing + echo + pull-forward + cell task ids + introduction pacing **shipped 2026-08-20** (per-session cap `min(5,L)`, soft daily throttle, ceiling 15/day); remainder: answer routes (typed/build/spoken), wrong-answer cell recording. | UC-041 | [`form-practice.md`](../specs/service/form-practice.md), [`form-inverse-index.md`](../specs/service/form-inverse-index.md) | **Sensitive** | W-4 |
