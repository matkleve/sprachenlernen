...
<!-- id: UC-011 -->
<!-- specs: SPEC-service-auth, SPEC-page-landing, SPEC-feature-privacy-consent, SPEC-service-session-builder, SPEC-feature-review-session, SPEC-service-starter-deck, SPEC-page-language-picker -->
