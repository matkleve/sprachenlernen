...
**Who:** someone who has just installed the app and has not yet decided whether
they mean it.
...
- From opening the app, the first real exercise is reachable in well under a
  minute, and the only choice needed is the language pair.
...
- No account is required to start. If one is needed later, the work done so far
  survives the moment it is created.
