...
| --- | --- | --- |
| `Button` | review session, method menu, auth, progress, account | yes |
| `Field`, `Input` | `/signup`, `/login`, account export | yes |
| `Table` | `/languages`, `/progress` | yes |
| `Select` | `/account` export scope | yes |
| `Dialog` | `/account` delete confirmation | yes |

`/primitives` redirects to `/languages`. State-coherence example:
