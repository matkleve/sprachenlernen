...
- A text can be added by file, paste or link, and is treated exactly like any
  other text: coverage shown before opening, tap a word for meaning in context,
  tap a sentence for a translation, unknown words offered as cards.
- The coverage figure appears **before** the learner starts, so they can decide
  whether to read it now or build up to it (UC-032).
