...
## A · Flashcards and repetition → [04](../study/STUDY-004-flashcards-srs.md)
...
| F08 | Vocabulary atlas (frequency rank × stability) | D | M | **V1** — promoted to a primary display by [19](../study/STUDY-017-milestones-and-map.md) |
...
## B · Level and progress → [03](../study/STUDY-003-level-model.md)
...
## C · Reading → [05](../study/STUDY-005-input-reading-listening.md)
...
## D · Listening → [05](../study/STUDY-005-input-reading-listening.md)
...
## E · Production → [06](../study/STUDY-006-production.md)
...
## F · Offline and paper → [07](../study/STUDY-007-offline-and-paper.md)
...
| F69b | Photo of free writing **for correction** | D | M | **V2** — a different case: there is no key to compare against ([23](../study/STUDY-021-how-an-exercise-runs.md)) |
...
## G · Motivation and framing → [08](../study/STUDY-008-motivation.md)
...
| F80 | Leagues, hearts, XP, purchasable streak protection | — | — | **no** — see [10](../study/STUDY-009-antipatterns.md) |

---

## I · Method choice → [12](../study/STUDY-010-method-cards.md)
...
| F89 | Daily menu: exactly 3 cards, filtered by budget and setting | B | M | **V1** — this *is* the product ([11](BL-011-roadmap-open-questions.md), stage 1) |
...
| F94 | Effect estimate per method and signal, with a population prior and uncertainty | D | L | **later** — statistically hard, see [12](../study/STUDY-010-method-cards.md) |
...
## J · Perception → [13](../study/STUDY-011-pronunciation-perception.md)
...
## K · Accessibility → [14](../study/STUDY-012-accessibility.md)
...
## L · Chunks and phrases → [16](../study/STUDY-014-further-findings.md)
...
## M · Own content → [17](../study/STUDY-015-own-content.md)
...
## N · The language kit → [18](../study/STUDY-016-language-kit.md)
...
| F124 | Bootstrapping a new language: frequency list → tier C, generated lemma table → tier B, dated calibration → tier A | D | L | **V2** — the tier measures data, never whether content was checked ([18](../study/STUDY-016-language-kit.md)) |
| F125 | At tier C no level value, but the status "not measured" | D | S | **V2** |

---

## O · Milestones and map → [19](../study/STUDY-017-milestones-and-map.md)
...
## P · Speaking without AI → [20](../study/STUDY-018-speaking-and-sentences.md)
...
## Q · Info page and methods beyond the app → [12](../study/STUDY-010-method-cards.md)
...
## R · Catalogue and context → [21](../study/STUDY-019-method-catalogue-and-context.md)
...
| F150 | **Context filters first** — before floor, effect, preference | D | S | **V1** — corrects the menu order in [12](../study/STUDY-010-method-cards.md) |
...
## S · How an exercise runs → [23](../study/STUDY-021-how-an-exercise-runs.md)
...
## T · Speaking as the goal, stalling, the demonstrated level → [24](../study/STUDY-022-speaking-as-the-goal.md)
...
| F170 | No CEFR label on the sentence in a language below quality tier B | — | S | **V2** — [18](../study/STUDY-016-language-kit.md) |
...
| F175 | **Commitments** as a second catalogue entry type: standing, active/inactive, not a session | D | M | **V2** — [21](../study/STUDY-019-method-catalogue-and-context.md) assumed everything was a session |
...
| F182 | Divergent word → card or perception contrast | D | S | **V2** — [13](../study/STUDY-011-pronunciation-perception.md) |
| F183 | Live microphone **input indicator** — about the device, never the speaker | D | S | **V2** |

---

## O · Felt productivity → [25](../study/STUDY-023-why-it-does-not-feel-productive.md)
...
| F86 | Efficacy measurement built in (pre-test, cohorts, including dropouts) | — | L | **V2** — otherwise we repeat [01](../study/STUDY-001-duolingo.md), S5 |
...
## P · Readiness and guidance → [26](../study/STUDY-024-readiness-and-difficulty.md)
...
[26](../study/STUDY-024-readiness-and-difficulty.md) R4, R6 and R7.
...
## Q · Method viability and session budget → [42](../reviews/design/DR-042-method-usefulness-ux-audit.md)
...
## R · Early foundation and same-day return → [43](../study/archive/ARCH-043-early-foundation-sessions.md)
...
| # | Feature | Ev. | Eff. | Verdict |
| --- | --- | --- | --- | --- |
| F216 | **Foundation phase** — cap new cards; reserve slots for same-day resurfacing of fragile items | C/D | M | **V1 candidate** — T-W22; [44](../study/archive/ARCH-044-foundation-phase-expert-review.md) narrows scope |
...
> stage 1 ([11](BL-011-roadmap-open-questions.md)).

The order and the reasoning behind the cut are in
[11](BL-011-roadmap-open-questions.md).
