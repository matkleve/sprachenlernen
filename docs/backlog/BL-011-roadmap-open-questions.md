...
([18](../study/STUDY-016-language-kit.md), U1). A language without that field must not be
loadable.
...
> with a visible jump in every user's history ([03](../study/STUDY-003-level-model.md), honesty
> rule 4).
...
there is still no dated calibration ([18](../study/STUDY-016-language-kit.md)).
...
**and** re-scoring every review history. Reasoning: [03](../study/STUDY-003-level-model.md),
"The second axis".
...
([14](../study/STUDY-012-accessibility.md)), and changing it afterwards means bending everyone's
history.
...
rate, not for years" ([25](../study/STUDY-023-why-it-does-not-feel-productive.md) C4).

**F165–F170** belong here too — the goal skill in the headline and the sentence
on Home ([24](../study/STUDY-022-speaking-as-the-goal.md)). The demonstration sentence is the
...
([19](../study/STUDY-017-milestones-and-map.md), K3).
...
([13](../study/STUDY-011-pronunciation-perception.md)). It is the cheapest part of the stage — no
...
> **Risk of this stage** ([15](../study/STUDY-013-landscape.md)): here we compete against
...
([12](../study/STUDY-010-method-cards.md)), plus **F171–F178** (stagnation detection and
...
([24](../study/STUDY-022-speaking-as-the-goal.md) S3).
...
[25](../study/STUDY-023-why-it-does-not-feel-productive.md) argues that the absence of real use is
...
extension, not the prerequisite ([20](../study/STUDY-018-speaking-and-sentences.md)).

### Stage 6 · Refinement

Everything marked **V2** and **later** in [09](BL-009-feature-catalogue.md), sorted
...
| # | What | Why not later |
| --- | --- | --- |
| **F107** | Every skill-bound spec names its alternative route | A process rule. Free from the first spec; afterwards a task-model change with user data attached ([14](../study/STUDY-012-accessibility.md)) |
...
| **F85** | A reporting route for wrong content | From the first generated sentence. Without it there is no feedback on how good the generation actually is ([10](../study/STUDY-009-antipatterns.md), A5) |

---

## How we will know whether the app works

The lesson from [01](../study/STUDY-001-duolingo.md), S5: efficacy measurement is possible but is
...
4. **Two figures side by side, never one:** return rate **and** measured progress.
   Their ratio is what answers the question from [08](../study/STUDY-008-motivation.md) — whether
...
- **Two calibrations**, not one. The vocabulary anchors in
  [03](../study/STUDY-003-level-model.md) are **[C]** and must be adjusted per language.
...
[10](../study/STUDY-009-antipatterns.md) cuts leagues, hearts and XP. That is the most consistent
position, and it is a risk ([08](../study/STUDY-008-motivation.md), the honesty caveat). Are you
...
Worked out in [12](../study/STUDY-010-method-cards.md), "Hiding": reachable only from settings
...
A15 in [10](../study/STUDY-009-antipatterns.md) stands and is bounded: it forbids the
**algorithm** from sorting out, not the human.

### 12 · Which methods get which floor?

The table in [12](../study/STUDY-010-method-cards.md) is a proposal **[D]**, not a research
...
[03](../study/STUDY-003-level-model.md).

### 13 · Real speakers or TTS for HVPT?

Variability between speakers is the **active ingredient** of HVPT, not the
packaging ([13](../study/STUDY-011-pronunciation-perception.md)). Several high-quality TTS voices
...
[15](../study/STUDY-013-landscape.md) rests on product descriptions, not first-hand use. Before
...
Worked out in [24](../study/STUDY-022-speaking-as-the-goal.md) S1, and the load-bearing part is
...
[12](../study/STUDY-010-method-cards.md) keeps preference and measured effect strictly separate
and never nets them. Perceived effort is neither of the two: it is the *cause* of
method choice ([25](../study/STUDY-023-why-it-does-not-feel-productive.md) P2), which is a reason
...
The diagnosis in [25](../study/STUDY-023-why-it-does-not-feel-productive.md) is that the largest
...
([25](../study/STUDY-023-why-it-does-not-feel-productive.md) C4). Using them for a German speaker
...
([19](../study/STUDY-017-milestones-and-map.md)). Either the band is labelled as borrowed, or it
...
The one quantity everything in [26](../study/STUDY-024-readiness-and-difficulty.md) inherits.
...
([12](../study/STUDY-010-method-cards.md)). Spending one on a method the app has just said works
...
[12](../study/STUDY-010-method-cards.md) says a method without a named target signal cannot be
...
and [03](../study/STUDY-003-level-model.md)'s seven signals measure none of those.
...
measurement is least valid ([02](../study/STUDY-002-evidence.md), E4). Restricting the rule to
hosted methods concedes that half the catalogue sits outside layer 1, which is
already the position of [12](../study/STUDY-010-method-cards.md), thesis 9 — but it also means
...
Surfaced 2026-08-20 by owner UX review ([43](../study/archive/ARCH-043-early-foundation-sessions.md)).
...
[44](../study/archive/ARCH-044-foundation-phase-expert-review.md).
