...
production ([01](01-duolingo.md), D4).
...
immediate feedback ([02](02-evidence.md), E10).
...
more than those who work it out themselves ([02](02-evidence.md), E10). So: a
...
> [13](13-pronunciation-perception.md) and works on **perception**, not
...
| --- | --- | --- |
| **Build a sentence with a target word** | activating fresh cards | minimal — belongs in the SRS ([04](04-flashcards-srs.md)) |
...
[03](03-level-model.md) and only they make visible which kind of error is
receding over weeks.
...
- The error categories as a closed list in [`../GLOSSARY.md`](../GLOSSARY.md).
  Invented categories make the weekly comparison in [03](03-level-model.md)
  worthless.
