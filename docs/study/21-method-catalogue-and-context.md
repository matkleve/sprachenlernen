...
[12](12-method-cards.md) describes the **mechanism** — how selection works, what
...
out of malice, but because it would damage itself ([01](01-duolingo.md), D1).
...
someone may learn rebuilds the barrier to entry from [01](01-duolingo.md), S1.
...
([05](05-input-reading-listening.md)), shadowing and self-talk, and the worst for
...
[12](12-method-cards.md).** A favourites list is a clean interface for the
...
1. **With one user the effect estimate is noise for months.** Tiny sample, massive
   confounders, slow feedback ([12](12-method-cards.md), "How the algorithm
...
> 1 from [11](11-roadmap-open-questions.md) in concrete form.
...
| Method | Trains | Context | Ev. | |
| --- | --- | --- | --- | --- |
| Paradigm tables, **mixed** | automatisation ([03](03-level-model.md)) | paper or keyboard | A | **hard** |
...
| Closing a frequency block deliberately | coverage ([19](19-milestones-and-map.md)) | touch | A | |
...
1. **The catalogue is data, not code.** A method is an entry with a target
   ...
   ([12](12-method-cards.md)). Adding methods must not be development work — or
...
3. **About half the catalogue happens outside the app** and is not measured
   ([12](12-method-cards.md), thesis 9). That is deliberate.
