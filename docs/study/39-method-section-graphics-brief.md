...
[33](33-skill-tier-badges-exploration.md) (skill-tier shields), and
[35](35-logo-and-pwa-icon-exploration.md) (spiral-learning app mark).
...
From [22](22-visual-design.md) and [`DESIGN-SYSTEM.md`](../DESIGN-SYSTEM.md):
