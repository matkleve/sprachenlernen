...
[15](15-landscape.md) names as a real risk that we compete against specialists
...
[05](05-input-reading-listening.md) requires 95–98 % known words, a normal
...
untestable claim [02](02-evidence.md), E4 criticises in Krashen. But there are
...
That is a textbook case for [12](12-method-cards.md): effective and unpopular. So
...
visibility level from [05](05-input-reading-listening.md), unfolded over time.
...
and that is exactly the pattern [02](02-evidence.md), E13 warns about.
...
| --- | --- | --- |
| Requires a retrieval attempt? | no — you read and compare | **yes**, for every gap ([02](02-evidence.md), E1) |
...
([04](04-flashcards-srs.md), audio recall) and words containing an unsolved
phonetic contrast ([13](13-pronunciation-perception.md)). That turns a generic
...
as in [05](05-input-reading-listening.md), unknown words become cards.
...
the language ([10](10-antipatterns.md), A5).
