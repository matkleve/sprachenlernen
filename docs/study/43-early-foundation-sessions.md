...
Related: [04](04-flashcards-srs.md) (card staging, backlog), [25](25-why-it-does-not-feel-productive.md)
(empty feeling), [26](26-readiness-and-difficulty.md) (targeting not gating),
[03](03-level-model.md) (held / fragile / new).
...
[E2](02-evidence.md): distributed practice beats massed practice **across days**.
That is the core justification for FSRS and for not showing 900 cards after a
two-week break ([04](04-flashcards-srs.md), backlog trap).
...
[E3](02-evidence.md): full production recall on a brand-new item is too hard;
recognition and meaning recall come first. [04](04-flashcards-srs.md) tables
...
creates a **multi-day desert** before forms exist — which [26](26-readiness-and-difficulty.md)
...
[25](25-why-it-does-not-feel-productive.md) P2: learners rate effortful
...
glass-walled schedule (G1 in [04](04-flashcards-srs.md)) can show "recall today:
89 %."
...
This aligns with thesis 13 ([26](26-readiness-and-difficulty.md)): the app
...
| Artefact | Purpose |
| --- | --- |
| [`docs/study/43-early-foundation-sessions.md`](43-early-foundation-sessions.md) | This chapter — **why** |
...
| [`docs/study/09-feature-catalogue.md`](09-feature-catalogue.md) | F216–F218 (below) |
| [`docs/study/11-roadmap-open-questions.md`](11-roadmap-open-questions.md) | Question 20 |
...
| No backlog counter ([04](04-flashcards-srs.md)) | Resurfacing is not "871 overdue" |
...
| --- | --- | --- | --- | --- |
| F216 | **Foundation phase** — throttle new cards while `held` below threshold; same-day resurfacing slots | C/D | M | **V1 candidate** — [43](43-early-foundation-sessions.md) |
| F217 | **Session sampling by retrievability** — soft inclusion below hard `due` for fragile tasks only | B | M | **V2** — [43](43-early-foundation-sessions.md) |
| F218 | **Soft form staging ramp** — forms weighted in after first meaning success, full weight after held | B | S | **V1 candidate** — [43](43-early-foundation-sessions.md) |

Copy component for F216 (ties to [25](25-why-it-does-not-feel-productive.md) F186):
...
5. **Enthusiasm** — resurfacing fixes *competence signal*; [25](25-why-it-does-not-feel-productive.md)
...
- **[04](04-flashcards-srs.md):** adds **intra-day** return as complementary to
  inter-day FSRS — not a replacement.
- **[26](26-readiness-and-difficulty.md):** form **gating** should move toward
  **targeting** (M3) — thesis 13 applied to the empty Formen path.
- **[25](25-why-it-does-not-feel-productive.md):** early empty sessions are often
...
| ⬤ | Spacing effect across sessions/days | [A] — [02](02-evidence.md) E2 |
| ⬤ | Production staged after meaning | [A/B] — [02](02-evidence.md) E3 |
| ⬤ | Misinterpreted-effort / need for visible return | [A] — [25](25-why-it-does-not-feel-productive.md) P2 |
