...
**For us:** the placement test ([03](03-level-model.md)) must **not** come
...
users quit (see [04](04-flashcards-srs.md), "The backlog trap").
...
tests by roughly 20 % (see [02](02-evidence.md), E3).
...
and including the dropouts. See [11](11-roadmap-open-questions.md), "How we will
...
difference. See [04](04-flashcards-srs.md).
...
rather than sentence confetti. See [05](05-input-reading-listening.md) and
...
green-tick lie. See [06](06-production.md).
...
report errors. See [10](10-antipatterns.md), A5.
...
list. See [09](09-feature-catalogue.md), F14.
