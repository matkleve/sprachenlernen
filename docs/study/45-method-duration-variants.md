...
Research base: [01](01-duolingo.md) S2, [12](12-method-cards.md), [21](21-method-catalogue-and-context.md),
[23](23-how-an-exercise-runs.md), [42](42-method-usefulness-ux-audit.md).
...
- Compose scaling is hard to keep honest (most built methods still fail G7 under
  the old model).
- Users on prescribed paths expect **fixed lesson blocks** ([01](01-duolingo.md) S2:
...
| --- | --- | --- |
| Dictation | Sentences per pass | One sentence is a probe; six sentences is practice ([02](02-evidence.md) E1) |
| Build-a-sentence | Target words per batch | One production attempt is warm-up, not a session ([42](42-method-usefulness-ux-audit.md)) |
