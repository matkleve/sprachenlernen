...
coverage for that specific user** does ([02](02-evidence.md), E4). We know their
...
> **Correction from [15](15-landscape.md), K1:** the principle is not new — LingQ
...
- **The loop back to the cards.** At equal coverage, the text containing the most
  **recently learned** cards wins ([04](04-flashcards-srs.md), the one-way-street
  trap).
...
understand — and then the exercise is worthless ([02](02-evidence.md), E1: no
...
- **Reading time measured**: words per minute is a layer-1 signal for
  [03](03-level-model.md) and the only one that makes automatisation visible.

### Text sources **[D]**

Generated at first (see [10](10-antipatterns.md), A5 on the quality obligation),
...
what beginners lack ("they speak so fast") ([02](02-evidence.md), E11).
