...
([12](STUDY-010-method-cards.md), thesis 6).
...
Self-determination theory ([08](STUDY-008-motivation.md), E7): displays that say
...
[12](STUDY-010-method-cards.md) deliberately omits thumbs percentages on cards.
...
E13 ([02](STUDY-002-evidence.md)): teaching learners *how* methods work helps; showing
evidence corrects misjudgement only partly. The info page is still right because
the alternative is "trust us" ([12](STUDY-010-method-cards.md)).
...
per meaning ([22](STUDY-020-visual-design.md) — constraints, not decoration). Gestalt
...
([21](STUDY-019-method-catalogue-and-context.md) — background listening: "barely any
yield").
