...
rationally optimise past the language ([01](STUDY-001-duolingo.md), D1).
**Costs us:** probably usage frequency. Duolingo's mechanics demonstrably work;
our alternative is reasoned but unproven ([08](STUDY-008-motivation.md), the honesty
caveat).
...
failure ([02](STUDY-002-evidence.md), E1). An app that punishes errors makes users
choose easier tasks — the exact opposite of [02](STUDY-002-evidence.md), E6.
...
([04](STUDY-004-flashcards-srs.md), the backlog trap). The number does not inform, it
shames.
...
damages trust in every other signal ([01](STUDY-001-duolingo.md), D4).
...
**Because:** no retrieval attempt, no learning ([02](STUDY-002-evidence.md), E1). The
...
**Because:** explicit explanation works ([02](STUDY-002-evidence.md), E5) — but at the
...
([01](STUDY-001-duolingo.md), S1). A test is an examination as a greeting.
...
is never used again ([05](STUDY-005-input-reading-listening.md)).
...
([12](STUDY-010-method-cards.md), corrected 2026-08-08).
...
> [12](STUDY-010-method-cards.md). A conscious decision is different from a
