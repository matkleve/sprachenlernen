...
Parent: [43](../archive/ARCH-043-early-foundation-sessions.md). Decisions locked elsewhere:
[ADR-0012/../../adr/0012-ux-decisions-requeue-i18n-leech-nav.md) (requeue),
[26](../STUDY-024-readiness-and-difficulty.md) (targeting not gating).
...
- **Do not** resurface every word graded `good` the same day — feels like the
  app ignores success ([25](../STUDY-023-why-it-does-not-feel-productive.md) P2).
...
| LT | E2/E3 [02](../STUDY-002-evidence.md), ch 26 targeting, ch 04 card staging, owner brief |
