...
Product UX (filter vs packages): [`archive/ARCH-045-method-duration-variants.md`](../archive/ARCH-045-method-duration-variants.md).
Five evaluated user stories: [`../IDEAS.md`/../../IDEAS.md) § 2026-08-20.
Input pipeline: [05](../STUDY-005-input-reading-listening.md), [17](../STUDY-015-own-content.md).
...
FSRS benefits from regular short sessions ([04](../STUDY-004-flashcards-srs.md)). **Fifteen
...
| Matches mental model ("news at my level") | LLM quality obligation ([10](../STUDY-009-antipatterns.md) A5) |
