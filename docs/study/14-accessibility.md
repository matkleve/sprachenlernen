...
The gap [sources.md](sources.md) flagged in itself. It is filled in here because
...
| HVPT ([13](13-pronunciation-perception.md)) | hearing fine contrasts |
...
level in [03](03-level-model.md) and therefore a depressed overall level, though
...
> [03](03-level-model.md), "The status of a skill" — **there and only there**.
...
1. **Explicit and structured** works particularly strongly here — the same
   direction as [02](02-evidence.md), E5, only more pronounced.
...
| Offer reading-while-listening as a default ([02](02-evidence.md), E11) | Build time pressure into retrieval tasks |
...
([05](05-input-reading-listening.md)'s listening half, and
...
([05](05-input-reading-listening.md), voice commands) — a decision taken for an
entirely different reason that pays off here.

- Screen reader completeness for all core flows, not just navigation.
  Particularly the displays from [03](03-level-model.md) and
  [04](04-flashcards-srs.md): a progress curve and a vocabulary atlas must have a
...
- The paper part ([07](07-offline-and-paper.md)) drops out or becomes the pure
  audio part (Ü4).
...
| **Fear of speaking** | See [16](16-further-findings.md) — writing is the asynchronous route, and the conversation partner has no audience |
...
[04](04-flashcards-srs.md) after user data hangs off it.
