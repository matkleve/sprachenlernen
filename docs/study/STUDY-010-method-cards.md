...
effects — retrieval, spacing, interleaving ([02](STUDY-002-evidence.md), E1/E2/E6) —
...
> ([01](STUDY-001-duolingo.md), D1) in a new disguise.**
...
| --- | --- | --- |
| Source | one tap after the session | level movement per hour invested, per method ([03](STUDY-003-level-model.md), V3) |
...
> **Shipped (2026-08-15, [27](STUDY-025-method-badges.md)):** method cards show plain
...
| **Duration** | Must be fixed in advance and be true ([01](STUDY-001-duolingo.md), S2) |
...
([02](STUDY-002-evidence.md), E7). But the same literature says learners with little
...
3. **Context filters first, not third.** ⚠ Corrected in
   [21](STUDY-019-method-catalogue-and-context.md): the order is
...
| Listening at level 1 (no transcript) | 2× / week | Otherwise there are no listening data and the listening level is guessed ([03](STUDY-003-level-model.md)) |
| Free production | 1× / week | The only source of production signals — and the only exercise that exposes avoidance ([06](STUDY-006-production.md)) |
| Dictation | 1× / 10 days | Finds words that exist only in writing ([07](STUDY-007-offline-and-paper.md)) |
| Reading at coverage | 2× / week | Activates cards in context ([04](STUDY-004-flashcards-srs.md)) |
...
([02](STUDY-002-evidence.md)) says the opposite — a structure the learner cannot decline
...
Question 11 from [11](../backlog/BL-011-roadmap-open-questions.md) is answered: **a method may
...
| **The consequence for the level is drawn, not hidden** | Hiding every method feeding a skill gives that skill the status **"not measured"** — never a low number. Defined in [03](STUDY-003-level-model.md), "The status of a skill" |
...
([04](STUDY-004-flashcards-srs.md)) builds.
...
([02](STUDY-002-evidence.md), E10) — and they arrive with wrong prior beliefs, see the
learning-styles myth in [16](STUDY-014-further-findings.md), W1.
...
| **What it does *not* do** | The limits. Dictation improves encoding, not retention ([02](STUDY-002-evidence.md), E9) |
...
([02](STUDY-002-evidence.md), E13). The info page is right nonetheless — not because it
...
| | |
| --- | --- |
| **Propose** | As a full method card, with info page and evidence grade like any other. Drama has evidence ([20](STUDY-018-speaking-and-sentences.md), S5) |
| **Prepare** | The vocabulary, the phrases, the sheet for the occasion — the mechanism from [07](STUDY-007-offline-and-paper.md), Ü5 and UC-026 |
...
[01](STUDY-001-duolingo.md), D1: **what is measurable displaces what counts.**
...
the level model ([03](STUDY-003-level-model.md)). Someone who spends a month doing
...
2. **It supports autonomy** ([02](STUDY-002-evidence.md), E7) and the ideal self
   ([16](STUDY-014-further-findings.md), W4). "You could put on a play" is an ideal-self
