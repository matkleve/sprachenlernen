...
1. **Direction of retrieval is not one skill.** Producing *casa* from "Haus"
   ...
   ([`../studie/02-evidenz.md`](../studie/02-evidenz.md) E3)
...
3. **The vocabulary estimate counts words, not questions.** The level model maps
   ...
   ([`../studie/03-level-modell.md`](../studie/03-level-modell.md))
...
([`../studie/03-level-modell.md`](../studie/03-level-modell.md)) becomes a query
...
- **Perceived workload.** A learner with 500 words has ~2,000 tasks. Never show
  ...
  ([`../studie/04-karteikarten-srs.md`](../studie/04-karteikarten-srs.md), F04)
...
([`../studie/03-level-modell.md`](../studie/03-level-modell.md), rule 4).
