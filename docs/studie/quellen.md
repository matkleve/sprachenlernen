...
Mit ehrlicher Kennzeichnung, wie belastbar der Nachweis ist. Das ist unüblich
und es ist der Grund, warum man dieser Studie mehr trauen kann als einer
Literaturliste ohne Angabe der Prüftiefe.

| Stufe | Bedeutet |
| --- | --- |
| **⬤ geprüft** | Quelle wurde beim Schreiben dieser Studie aufgerufen; Titel, Fundstelle und Kernaussage stammen daher |
| **◐ sekundär** | Kernaussage stammt aus einer Zusammenfassung oder Zitation in einer geprüften Quelle, nicht aus dem Original |
| **○ Vorwissen** | Standardliteratur, aus dem Gedächtnis zitiert und **nicht** in dieser Sitzung nachgeprüft. Vor Verwendung in einer Veröffentlichung nachschlagen |

Ein **○** heißt nicht „unzuverlässig" — es sind meist die bekanntesten Arbeiten
des Feldes. Es heißt: Jahreszahl, exakte Effektstärke oder genaue Formulierung
können abweichen.
...
| ⬤ | Mogavi, Guo et al. (2022): *When Gamification Spoils Your Learning: A Qualitative Case Study of Gamification Misuse in a Language-Learning App.* ACM Learning@Scale. [Link](https://dl.acm.org/doi/10.1145/3491140.3528274) | [01](01-duolingo.md) D1, [03](03-level-modell.md) V4, [08](08-motivation.md) |
| ⬤ | *The Effectiveness of Duolingo in Developing Receptive and Productive Skills.* Language Learning & Technology 28(1), 2024 — methodische Kritik am Forschungsstand. [Link](https://scholarspace.manoa.hawaii.edu/bitstreams/ea47a53e-da6e-4419-bd55-e72b458294f4/download) | [01](01-duolingo.md), [02](02-evidenz.md) E12 |
| ⬤ | *Investigating the Challenges of Using Duolingo* — Nutzerbefragung zu Motivationsverlust und Kulturvermittlung. [Link](https://contemporaryjournal.com/index.php/14/article/download/134/112/242) | [01](01-duolingo.md) D1 |
...
| ◐ | Loewen & Sato (2018) — Ungenauigkeit der Spracherkennung. Zitiert in der LLT-Übersicht oben | [01](01-duolingo.md) D4, [06](06-produktion.md) |
| ◐ | Van Deusen-Scholl & Friend (2019) — zu wenig Kontext und Erklärung. Zitiert in der LLT-Übersicht oben | [01](01-duolingo.md) D3 |

---

## Gedächtnis, Wiederholung, Abruf

| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Anki FAQ: *What spaced repetition algorithm does Anki use?* — FSRS seit 23.10. [Link](https://faqs.ankiweb.net/what-spaced-repetition-algorithm) | [04](04-karteikarten-srs.md) |
| ⬤ | open-spaced-repetition: *Comparison with SM-2* — Modellvariablen, Benchmarkergebnisse. [Link](https://deepwiki.com/open-spaced-repetition/fsrs-optimizer/7.3-comparison-with-sm-2) | [04](04-karteikarten-srs.md) |
| ◐ | Ye (2022, KDD): stochastische dynamische Programmierung für Wiederholungsplanung, ~12,6 % Verbesserung. Zitiert in den FSRS-Übersichten oben | [04](04-karteikarten-srs.md) |
| ○ | Roediger & Karpicke (2006): *Test-enhanced learning.* Psychological Science | [02](02-evidenz.md) E1 |
| ○ | Ebbinghaus (1885); Cepeda et al. (2006, 2008) zur Verteilung und zum optimalen Intervallverhältnis | [02](02-evidenz.md) E2 |
| ○ | Bjork & Bjork: *desirable difficulties* | [02](02-evidenz.md) E1, E6 |
| ○ | Dunlosky et al. (2013): Abrufübung und Verteilung als einzige Techniken mit hoher Nützlichkeitsbewertung | [02](02-evidenz.md) E1 |
| ◐ | Pan et al. (2019): Interleaving, d ≈ 0,67. Zitiert in einer Übersichtsdarstellung zu desirable difficulties | [02](02-evidenz.md) E6 |
...
| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Kremmel et al. (2023): *Unknown Vocabulary Density and Reading Comprehension: Replicating Hu and Nation (2000).* Language Learning. [Link](https://onlinelibrary.wiley.com/doi/10.1111/lang.12622) | [02](02-evidenz.md) E4 |
| ⬤ | Laufer & Ravenhorst-Kalovski (2010): *Lexical threshold revisited.* [Link](https://files.eric.ed.gov/fulltext/EJ887873.pdf) | [02](02-evidenz.md) E4, [03](03-level-modell.md) |
| ⬤ | *The Polish vocabulary size test: A novel adaptive test* — CAT/IRT als besserer Weg gegenüber Festformtests. [Link](https://pmc.ncbi.nlm.nih.gov/articles/PMC12339579/) | [03](03-level-modell.md) |
| ⬤ | *The LexTALE as a measure of L2 global proficiency: A cautionary tale* — Teilreplikation, Reliabilitätskritik. [Link](https://www.researchgate.net/publication/367375551_The_LexTALE_as_a_measure_of_L2_global_proficiency_A_cautionary_tale_based_on_a_partial_replication_of_Lemhofer_and_Broersma_2012) | [03](03-level-modell.md) |
| ⬤ | Sevigny, Mack, Stilp & Berger (2024): *High-Frequency Vocabulary: Moving From Recognition to Recall Level on Quizlet* — ~20 % Überschätzung durch Multiple Choice. [Link](https://journals.sagepub.com/doi/10.1177/21582440241242604) | [02](02-evidenz.md) E3 |
| ○ | Hu & Nation (2000); Nation (2006): *How large a vocabulary is needed for reading and listening?* | [02](02-evidenz.md) E4 |
| ○ | van Zeeland & Schmitt (2012): 95 %-Schwelle beim Hören mit 2.000–3.000 Wortfamilien | [02](02-evidenz.md) E4 |
| ○ | Nation & Webb zu rezeptiv/produktiv und zur Abfragerichtung (Vorwärts-/Rückwärtsübersetzung) | [02](02-evidenz.md) E3 |

---

## Unterricht, Grammatik, Korrektur

| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Norris & Ortega (2000): *Effectiveness of L2 Instruction: A Research Synthesis and Quantitative Meta-analysis.* Language Learning. [Link](https://eric.ed.gov/?id=EJ611436) | [02](02-evidenz.md) E5 |
| ⬤ | Spada & Tomita (2010): *Interactions Between Type of Instruction and Type of Language Feature.* Language Learning. [Link](https://onlinelibrary.wiley.com/doi/10.1111/j.1467-9922.2010.00562.x) | [02](02-evidenz.md) E5 |
| ◐ | Goo et al.: Neuauflage von Norris & Ortega — explizit vor implizit bestätigt. [Link](https://benjamins.com/catalog/sibil.48.18goo) | [02](02-evidenz.md) E5 |
| ○ | Krashen (1985): Input-Hypothese („i+1") — hier als *kritisierte* Referenz verwendet | [02](02-evidenz.md) E4 |
| ○ | Swain (1985): Output-Hypothese; Schmidt (1990): Noticing | [06](06-produktion.md) |
| ○ | Lyster & Ranta (1997) und Nachfolger: Prompts wirksamer als Recasts | [06](06-produktion.md) |
| ○ | DeKeyser: Skill Acquisition Theory, Automatisierung | [03](03-level-modell.md), [05](05-input-lesen-hoeren.md) |
| ○ | Lewis (1993): Lexical Approach, Chunks | [09](09-feature-katalog.md) F13 |
...
| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | *Gamification enhances student intrinsic motivation, perceptions of autonomy and relatedness, but minimal impact on competency: a meta-analysis and systematic review.* Educational Technology Research & Development (2023). [Link](https://link.springer.com/article/10.1007/s11423-023-10337-7) | [02](02-evidenz.md) E7, [08](08-motivation.md) |
...
| ○ | Deci & Ryan: Selbstbestimmungstheorie; Unterscheidung informational / kontrollierend | [02](02-evidenz.md) E7, [08](08-motivation.md) |

---

## Hören, Lesen, audiovisueller Input

| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | *Effectiveness of Subtitles in L2 Classrooms: A Meta-Analysis.* Education Sciences (2023). [Link](https://www.mdpi.com/2227-7102/13/3/274) | [02](02-evidenz.md) E11 |
| ⬤ | *On-Screen Texts in Audiovisual Input for L2 Vocabulary Learning: A Review.* [Link](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9136233/) | [02](02-evidenz.md) E11, [05](05-input-lesen-hoeren.md) |
| ⬤ | *Gains to L2 listeners from reading while listening vs. listening only in comprehending short stories.* System. [Link](https://www.sciencedirect.com/science/article/abs/pii/S0346251X09001067) | [02](02-evidenz.md) E11 |
| ⬤ | *Extensive Reading and Science Vocabulary Learning in L2: Comparing Reading-Only and Reading-While-Listening.* Education Sciences. [Link](https://doi.org/10.3390/educsci13050493) | [05](05-input-lesen-hoeren.md) |
| ○ | Krashen: Narrow Listening / Narrow Reading | [05](05-input-lesen-hoeren.md) |

---

## Schreiben, Diktat, Handschrift

| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Yu, Boers & Tremblay (2025): *Learning multiword items through dictation and dictogloss.* Language Teaching Research. [Link](https://journals.sagepub.com/doi/full/10.1177/13621688221117242) | [02](02-evidenz.md) E9, [07](07-offline-papier.md) |
| ⬤ | Van der Meer & Van Weel (2024): *Handwriting but not typewriting leads to widespread brain connectivity.* Frontiers in Psychology. [Link](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2023.1219945/full) | [02](02-evidenz.md) E8, [07](07-offline-papier.md) |
| ⬤ | Kommentar zur vorstehenden Arbeit (methodische Einschränkungen). [Link](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11750765/) | [02](02-evidenz.md) E8 |

---

## KI im Sprachenlernen

| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Lyu et al. (2025): *Effectiveness of Chatbots in Improving Language Learning: A Meta-Analysis of Comparative Studies.* IJAL — g ≈ 0,608. [Link](https://onlinelibrary.wiley.com/doi/full/10.1111/ijal.12668) | [02](02-evidenz.md) E10, [06](06-produktion.md) |
| ⬤ | Qiao: *Artificial Intelligence for Language Learning: A Systematic Review.* IJAL. [Link](https://onlinelibrary.wiley.com/doi/10.1111/ijal.70034?af=R) | [02](02-evidenz.md) E10 |
| ⬤ | *Transforming language education: A systematic review of AI-powered chatbots for EFL speaking practice.* [Link](https://www.sciencedirect.com/science/article/pii/S2666920X24000316) | [06](06-produktion.md) |
...
| | Quelle | Verwendet in |
| --- | --- | --- |
| ⬤ | Europarat: *The CEFR Levels* — sechs Stufen, ausdrücklich weiter unterteilbar „according to the needs of the local context". [Link](https://www.coe.int/en/web/common-european-framework-reference-languages/level-descriptions) | [03](03-level-modell.md) |

---

## Was fehlt

Ehrlichkeitshalber die Lücken dieser Studie:

- **Keine Primärrecherche zu Sublevel-Wortschatzankern.** Die Tabelle in
  [03](03-level-modell.md) ist **[C]** und muss pro Sprache empirisch
