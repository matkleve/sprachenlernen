...
[27](../../study/STUDY-025-method-badges.md) are called out explicitly.
...
| Section graphics | `method-section-*` webp | Same abstract/editorial 3D language; badges are the **micro** version of section headers — brief: [39/../../explorations/EXP-039-method-section-graphics-brief.md) |
...
| --- | --- | --- |
| [STUDY-025-method-badges.md](../../study/STUDY-025-method-badges.md) | 3 contribution levels; no metal words in UI | 5 tiers with wood→platinum names — **owner override pending** |
