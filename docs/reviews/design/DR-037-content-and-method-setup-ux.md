...
([study/26](../../study/STUDY-024-readiness-and-difficulty.md)). Preview after selection:
...
4. If **no** catalogue item exists for that topic — chip shows disabled state or
   ...
   **Your own**. No LLM generation ([study/10](../../study/STUDY-009-antipatterns.md) A5).

**3. Your own (last chip)**  
Upload / paste / link controls **appear only here** — not under other topics.

1. Parse locally where possible ([study/17](../../study/STUDY-015-own-content.md)).
...
- [`material-unit.md`](../../specs/service/material-unit.md) — session slice sizes;
  see also [`STUDY-027-material-units-and-listening-defer.md`](../../study/STUDY-027-material-units-and-listening-defer.md).
