...
technical detail also lives in [`29-ios-inset-by-route.md`](QA-029-ios-inset-by-route.md).
...
| Prior report | `docs/qa/QA-029-ios-inset-by-route.md` |
...
- [`29-ios-inset-by-route.md`](QA-029-ios-inset-by-route.md) — technical investigation
- [`28-mobile-desktop-layout.md`](../reviews/design/DR-028-mobile-desktop-layout.md) — phone vs iPad chrome
