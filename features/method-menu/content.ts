...
export const copy = {
  ...
  demonstrationFlipHint: "Tap to turn",
  demonstrationGradePrompt: "How well did you read it?",
  demonstrationFeedbackHard: "That one was tough — worth another look when you review.",
  demonstrationFeedbackGood: "You read that — a few words may need another look.",
  demonstrationFeedbackEasy: "You read that easily.",
  demonstrationGradeHard: "Hard",
  demonstrationGradeGood: "Good",
  demonstrationGradeEasy: "Easy",
  minutes: "min",
  or: "or",
