...
export const page = {
  ...
  intro:
    "One control, eight stages. Chapters change the whole token set; stages only add light, texture and depth on top of the chapter you are in. Nothing here is wired to learner data — this exists to answer whether a single step is worth noticing.",
  stageLabel: "Stage",
  litLabel: "Someone has been here recently",
  litHint:
    "Lamps you installed stay installed. This only decides whether they are on — coming back turns them up again.",
  builtLabel: "Installed",
  lampsUnit: "lamps",
