/** Spiral-learning mark artboard — matches scripts/build-spiral-learning-logo.py. */
export const BRAND_SPIRAL_VIEW = 512;

/**
 * Rotation pivot in SVG user units. Centroid of both traced bands (~248, 253);
 * artboard centre (256) is within 1% — close enough for a galaxy spin.
 */
export const BRAND_SPIRAL_PIVOT = 256;

/** Traced paths from spiral-learning-color.svg — keep in sync with build script. */
export const BRAND_SPIRAL_INNER_PATH =
...
export const BRAND_SPIRAL_OUTER_PATH =
